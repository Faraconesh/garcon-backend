# Generated by Django 2.1 on 2018-08-21 15:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userWeight', models.PositiveIntegerField(blank=True, null=True, verbose_name='User Weight')),
                ('customWeight', models.PositiveIntegerField(blank=True, null=True, verbose_name='Custom Weight')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.FileField(blank=True, null=True, upload_to='')),
                ('menuPicture', models.FileField(blank=True, null=True, upload_to='')),
                ('userWeight', models.PositiveIntegerField(blank=True, null=True, verbose_name='User Weight')),
                ('customWeight', models.PositiveIntegerField(blank=True, null=True, verbose_name='Custom Weight')),
            ],
        ),
