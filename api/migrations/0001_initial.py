    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(related_name='FoodCategory', to='api.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.FileField(blank=True, null=True, upload_to='')),
                ('categories', models.ManyToManyField(related_name='RestaurantCategory', to='api.Category')),
            ],
        ),
        migrations.AddField(
            model_name='food',
